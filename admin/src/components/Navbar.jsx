...
import { UserIcon,ShoppingBagIcon,ClipboardListIcon, HomeIcon, PanelLeftIcon } from 'lucide-react'
...
function Navbar() {
  ...
  return (
    <div className='navbar w-full bg-base-300'>
        <label htmlFor="my-check" className='btn btn-square btn-ghost' aria-label='open sidebar'>
