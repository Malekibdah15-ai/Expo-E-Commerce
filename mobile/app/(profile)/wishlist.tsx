...
const wishlist = () => {
  ...
  const {addingToCart,isAddingToCart} = useCart()
  ...
  const handleAddingToCart = (productId: String, productName: String)=>{
    addingToCart(
      {productId, quantity: 1},
      {
      onSuccess: () => Alert.alert("success", `${productName} is added to cart`),
                ...
                >
                  ...
                  {item.stock > 0 &&(
                    <View className='px-4 pb-4'>
                      ...
                      activeOpacity={0.8}
                      onPress={()=> handleAddingToCart(item._id, item.name)}
