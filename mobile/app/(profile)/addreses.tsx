...
import { Address } from '@/types/indexT';
    ...
    if(editingAddressId){
      ...
      },
      {
       onSuccess: () => {
        ...
        setEditingAddressId(null)
        Alert.alert("success", "Address updated successfuly")
       } ,
       onError: (error: any)=>{
        Alert.alert("Error", error?.recponse?.data?.error || "Failed to update the address")
       }})
    }else{
